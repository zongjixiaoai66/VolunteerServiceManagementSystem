        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='huodong'">
                    <el-form-item class="select" v-if="type!='info'"  label="志愿活动" prop="huodongId">
                        <el-select v-model="ruleForm.huodongId" :disabled="ro.huodongId" filterable placeholder="请选择志愿活动" @change="huodongChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="活动时间" prop="huodongShijian">
                        <el-input v-model="huodongForm.huodongShijian"
                                  placeholder="活动时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="可报名人数" prop="huodongKucunNumber">
                        <el-input v-model="huodongForm.huodongKucunNumber"
                                  placeholder="可报名人数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="活动状态" prop="statusValue">
                        <el-input v-model="huodongForm.statusValue"
                                  placeholder="活动状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="活动状态" prop="statusValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="报名截止时间" prop="jiezhiTime">
                        <el-input v-model="huodongForm.jiezhiTime"
                                  placeholder="报名截止时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="报名截止时间" prop="jiezhiTime">
