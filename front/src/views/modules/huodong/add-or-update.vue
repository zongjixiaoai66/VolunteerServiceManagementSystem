<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-col :span="12">
                <el-form-item class="select" v-if="type!='info'"  label="活动状态" prop="statusTypes">
                    <el-select v-model="ruleForm.statusTypes" :disabled="ro.statusTypes" placeholder="请选择活动状态">
                        <el-option
