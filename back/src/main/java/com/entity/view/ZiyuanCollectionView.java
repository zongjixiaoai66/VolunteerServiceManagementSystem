...
public class ZiyuanCollectionView extends ZiyuanCollectionEntity implements Serializable {
	...
	*/
	...
	private String ziyuanCollectionValue;
	...
	public ZiyuanCollectionView() {

	}

	public ZiyuanCollectionView(ZiyuanCollectionEntity ziyuanCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, ziyuanCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getZiyuanCollectionValue() {
		return ziyuanCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setZiyuanCollectionValue(String ziyuanCollectionValue) {
		this.ziyuanCollectionValue = ziyuanCollectionValue;
	}
	...
	public String toString() {
		return "ZiyuanCollectionView{" +
			", ziyuanCollectionValue=" + ziyuanCollectionValue +
