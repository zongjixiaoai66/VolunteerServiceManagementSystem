...
//                            huodongEntity.setHuodongShijian(data.get(0));                    //活动时间 要改的
...
//                            huodongEntity.setHuodongKucunNumber(Integer.valueOf(data.get(0)));   //可报名人数 要改的
//                            huodongEntity.setHuodongClicknum(Integer.valueOf(data.get(0)));   //活动热度 要改的
//                            huodongEntity.setStatusTypes(Integer.valueOf(data.get(0)));   //活动状态 要改的
//                            huodongEntity.setJiezhiTime(sdf.parse(data.get(0)));          //报名截止时间 要改的
