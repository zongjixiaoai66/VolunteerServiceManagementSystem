...
var centerMenu = [
    ...
    ,{
        name: '捐赠信息',
        url: '../junazheng/list.html'
    }
    ,{
        name: '资源收藏',
        url: '../ziyuanCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '志愿资源',
        url: './pages/ziyuan/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/ziyaunfuwuguanli/admin/dist/index.html#/login";
